...
from research import build_research_links, calculate_demand_score, calculate_competition_score, calculate_opportunity_score, calculate_evidence_confidence
...
evidence_inputs = {
    "searches": searches, "listings": listings, "top_price": top_price,
    "avg_reviews": avg_reviews, "trend": trend, "reddit_volume": reddit_vol,
...
if st.button("💼 Commercialize Idea", type="primary"):
    ...
    st.write(**Product Specification:**, comm["product_spec"])
    st.write(**Pricing Strategy:**, comm["pricing_strategy"])
    
    st.write(**Key Features / Pages:**)
